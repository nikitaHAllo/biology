...
interface VirusCaseCreation
	extends Optional<VirusCaseAttributes, 'id' | 'description' | 'patient_info' | 'difficulty' | 'coins_reward' | 'order_index' | 'is_active' | 'created_at' | 'updated_at'> {}
...
interface VirusResultCreation
	extends Optional<VirusResultAttributes, 'id' | 'score' | 'clues_used' | 'coins_earned' | 'is_completed' | 'completed_at' | 'created_at' | 'updated_at'> {}
